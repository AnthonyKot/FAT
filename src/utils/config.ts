...
export enum FinancialMetric {
  ...
  PATENT_COUNT_GROWTH = 'Patent Count Growth',
  NEW_PRODUCT_REVENUE = 'New Product Revenue Percentage',
  REVENUE_PER_PATENT = 'Revenue per Patent',
  RD_EFFECTIVENESS = 'R&D Effectiveness (Revenue Growth to R&D Ratio)',
  INNOVATION_REVENUE = 'Innovation Revenue Percentage',
  RETURN_ON_RESEARCH_CAPITAL = 'Return on Research Capital',
  RD_GROWTH_RATE = 'R&D Growth Rate',
  TECH_ADOPTION_RATE = 'Technology Adoption Rate',
  INNOVATION_INVESTMENT = 'Innovation Investment Intensity'
}
...
export const METRIC_CATEGORIES = {
  ...
  [MetricCategory.RESEARCH_INNOVATION]: [
    ...
    FinancialMetric.PATENT_COUNT_GROWTH,
    FinancialMetric.NEW_PRODUCT_REVENUE,
    FinancialMetric.REVENUE_PER_PATENT,
    FinancialMetric.RD_EFFECTIVENESS,
    FinancialMetric.INNOVATION_REVENUE,
    FinancialMetric.RETURN_ON_RESEARCH_CAPITAL,
    FinancialMetric.RD_GROWTH_RATE,
    FinancialMetric.TECH_ADOPTION_RATE,
    FinancialMetric.INNOVATION_INVESTMENT
  ]
};
...
export const METRIC_DATA_PATHS: Record<FinancialMetric, string> = {
  ...
  [FinancialMetric.PATENT_COUNT_GROWTH]: 'innovationMetrics.patentCountGrowth',
  [FinancialMetric.NEW_PRODUCT_REVENUE]: 'innovationMetrics.newProductRevenue',
  [FinancialMetric.REVENUE_PER_PATENT]: 'innovationMetrics.revenuePerPatent',
  [FinancialMetric.RD_EFFECTIVENESS]: 'innovationMetrics.rdEffectiveness',
  [FinancialMetric.INNOVATION_REVENUE]: 'innovationMetrics.innovationRevenue',
  [FinancialMetric.RETURN_ON_RESEARCH_CAPITAL]: 'innovationMetrics.returnOnResearchCapital',
  [FinancialMetric.RD_GROWTH_RATE]: 'innovationMetrics.rdGrowthRate',
  [FinancialMetric.TECH_ADOPTION_RATE]: 'innovationMetrics.techAdoptionRate',
  [FinancialMetric.INNOVATION_INVESTMENT]: 'innovationMetrics.innovationInvestment'
};